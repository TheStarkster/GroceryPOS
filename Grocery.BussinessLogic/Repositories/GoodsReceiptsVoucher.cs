...
{
    public class GoodsReceiptsVoucher
    {
        ...
        public static DataSet Get(string type, string invoiceId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_grv_Get_win", GroceryDML.Connection))
            {
        ...
        public static string Set(grv_master objHeader, List<grv_details> objLine)
        {
            SqlConnection con = GroceryDML.Connection;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Sp_grv_Set_win", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
