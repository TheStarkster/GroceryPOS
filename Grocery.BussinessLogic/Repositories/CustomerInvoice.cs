...
namespace Grocery.BussinessLogic.Repositories
{
    public class CustomerInvoice
    {
        ...
        public static DataSet Get(string type, string invoiceId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_SalesInvoice_Get_win", GroceryDML.Connection))
            {
        ...
        public static string Set(sales_master objHeader, List<sales_details> objLine)
        {
            SqlConnection con = GroceryDML.Connection;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Sp_SalesInvoice_Set_win", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
