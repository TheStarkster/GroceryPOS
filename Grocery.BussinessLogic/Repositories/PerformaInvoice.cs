...
namespace Grocery.BussinessLogic.Repositories
{
    public class PerformaInvoice
    {
        ...
        public static DataSet Get(string type, string invoiceId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_Proforma_Invoice_Get_win", GroceryDML.Connection))
            {
        ...
        public static string Set(proforma_master objHeader, List<proforma_details> objLine)
        {
            SqlConnection con = GroceryDML.Connection;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Sp_Proforma_Invoice_Set_win", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.Add("@purcurency", SqlDbType.VarChar).Value = objHeader.purcurency;
                ...
                foreach (var item in objLine)
                {
                    using (SqlCommand cmd = new SqlCommand("Sp_Proforma_Invoice_Set_win", con))
                    {
                        ...
                        cmd.Parameters.Add("@UnitPriceAED", SqlDbType.Decimal).Value = item.UnitPriceAED;
    ...
    public class proforma_master
    {
        ...
        public string purcurency { get; set; }
