...
namespace Grocery.BussinessLogic.Repositories
{
    public class PurchaseReturn
    {
        ...
        public static DataSet Get(string type, string invoiceId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_purchasereturn_Get_win", GroceryDML.Connection))
            {
        ...
        public static string Set(purchasereturn_master objHeader, List<purchasereturn_details> objLine)
        {
            SqlConnection con = GroceryDML.Connection;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Sp_purchasereturn_Set_win", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
    ...
    [Serializable]
    public class purchasereturn_master
    {
    ...
    [Serializable]
    public class purchasereturn_details
    {
        public string invoiceId { get; set; }
