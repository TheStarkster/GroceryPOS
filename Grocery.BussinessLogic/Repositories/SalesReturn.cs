...
namespace Grocery.BussinessLogic.Repositories
{
    public class SalesReturn
    {
        ...
        public static DataSet Get(string type, string invoiceId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_SalesReturn_Get_win", GroceryDML.Connection))
            {
        ...
        public static string Set(salesreturn_master objHeader, List<salesreturn_details> objLine)
        {
            SqlConnection con = GroceryDML.Connection;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Sp_SalesReturn_Set_win", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
    ...
    [Serializable]
    public class salesreturn_master
    {
    ...
    [Serializable]
    public class salesreturn_details
    {
        public string invoiceId { get; set; }
