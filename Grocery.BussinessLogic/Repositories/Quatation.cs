...
namespace Grocery.BussinessLogic.Repositories
{
    public class Quatation
    {
        ...
        public static DataSet Get(string type, string invoiceId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("Sp_Quotation_Get_win", GroceryDML.Connection))
            {
        ...
        public static string Set(quot_master objHeader, List<quot_details> objLine)
        {
            SqlConnection con = GroceryDML.Connection;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Sp_Quotation_Set_win", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
